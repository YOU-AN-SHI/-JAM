...
# a.place(x=60,y=20)
photo4 = PhotoImage(file='questionPage2.gif')
photoL4 = Label(tk,image = photo4,bg = '#468bcc')
photoL4.place(x = 0 , y = 0)
...
sent1 = Button(tk,text = '送出',width=7,height=2,command= wa2py)
