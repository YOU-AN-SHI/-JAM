...
canvas.create_text(755, 170, text='問題三:天上有幾顆星星?',fill = '#000000', font=('Arial', 25))
...
canvas.create_text(430.5, 332, text='輸入你認為天上有幾顆星星',fill = '#000000', font=('Arial', 15))
...
canvas.create_text(720, 332, text='天上星星數量',fill = '#000000', font=('Arial', 15))
...
canvas.create_text(360, 487, text='50,000,000',fill = '#000000', font=('Arial', 15))
...
canvas.create_text(808, 487, text='70,000,000,000,000,000,000,000',fill = '#000000', font=('Arial', 15))
...
bt_1 = Button(tk, text='送出解答', bg='#2cba1d', fg='white', font=('Arial', 15),command= answer3py)
