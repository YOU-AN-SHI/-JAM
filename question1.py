...
photo1 = PhotoImage(file='searchBox.gif')
photoL1 = Label(tk,image = photo1)
photoL1.place(x = 800 , y = 25)
photo2 = PhotoImage(file='home.gif')
photoL2 = Label(tk,image = photo2,bg = '#468bcc')
photoL2.place(x = 1480 , y = 18)

canvas.create_text(730, 170, text='問題一:燕巢誰最帥?',fill = '#000000', font=('Arial', 25))
...
canvas.create_text(430, 332, text='輸入你認為最帥之人的名字',fill = '#000000', font=('Arial', 15))
...
canvas.create_text(730, 332, text='最帥之人的名字',fill = '#000000', font=('Arial', 15))
...
canvas.create_text(340, 487, text='王小明',fill = '#000000', font=('Arial', 15))
...
canvas.create_text(690, 487, text='王小明',fill = '#000000', font=('Arial', 15))
...
bt_1 = Button(tk, text='送出解答', bg='#2cba1d', fg='white', font=('Arial', 15),command = answer1py)
